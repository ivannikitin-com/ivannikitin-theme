...
function in_2019_woocommerce_scripts() {
	...
	wp_add_inline_style( 'in-2019-woocommerce-style', $inline_font );
}
...
if ( ! function_exists( 'in_2019_woocommerce_cart_link' ) ) {
	...
	function in_2019_woocommerce_cart_link() {
		?>
		<a class="cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'in-2019' ); ?>">
			<?php
